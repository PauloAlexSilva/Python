...
utilizando Double Under para não gerar conflito com os nomes desses elemementos
na programação.
...
o Python atribuirá a variável __name__ o valor __main__ indicando que este módulo é o
