...
open() -> Na forma mais simples de utilização passamos apenas um parâmetro de entrada,
que neste caso é o caminho/nome para o arquivo a ser lido. Essa função retorna um _io.TextIOWrapper
